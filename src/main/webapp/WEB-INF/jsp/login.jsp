            ...
            <div class="col-md-10  col-sm-12 col-xs-14 login-col">
                ...
                <div class="tab-content">
                    ...
                    <div id="regform" class="tab-pane fade">
                        <form action="${pageContext.request.contextPath}/admin/loging.html" method="post">
                            <div class="form-group">
                                <label>用户名:</label>
                            ...
                            <div class="form-group">
                                <label>手机:</label>
                                <input type="text" name="phone" class="form-control" placeholder="用常用的手机号码">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                        <input value="点击获取验证码" type="button" name="emailCode" class="form-control btn btn-default">
                                    </div>
                                </div>
                            </div>
